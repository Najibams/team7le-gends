...
if page == "📈 Analyse":
    ...
    with col1:
        ...
        if not filtered_for_graphs.empty:
            ...
            # Checkbox voor metrostation weergave

            show_metro_stations = st.checkbox("Toon metrostations", value=True)
            ...
            # Voeg metrostations toe aan de kaart indien geselecteerd

            if show_metro_stations and not london_stations_df.empty:
